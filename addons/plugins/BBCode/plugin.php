...
{
	addToArrayString($controls, "fixed", "<a href='javascript:BBCode.fixed(\"$id\");void(0)' title='".T("Code")."' class='bbcode-fixed'><span>".T("Kood")."</span></a>", 0);
	addToArrayString($controls, "image", "<a href='javascript:BBCode.image(\"$id\");void(0)' title='".T("Image")."' class='bbcode-img'><span>".T("Pilt")."</span></a>", 0);
	...
	addToArrayString($controls, "strike", "<a href='javascript:BBCode.strikethrough(\"$id\");void(0)' title='".T("Strike")."' class='bbcode-s'><span>".T("Kriipsutatud")."</span></a>", 0);
	addToArrayString($controls, "header", "<a href='javascript:BBCode.header(\"$id\");void(0)' title='".T("Header")."' class='bbcode-h'><span>".T("Pealkiri")."</span></a>", 0);
	addToArrayString($controls, "italic", "<a href='javascript:BBCode.italic(\"$id\");void(0)' title='".T("Italic")."' class='bbcode-i'><span>".T("Kaldkiri")."</span></a>", 0);
	addToArrayString($controls, "bold", "<a href='javascript:BBCode.bold(\"$id\");void(0)' title='".T("Bold")."' class='bbcode-b'><span>".T("Rasvane")."</span></a>", 0);
	addToArrayString($controls, "punane", "<a href='javascript:BBCode.punane(\"$id\");void(0)' title='".T("Punane")."' class='icon-star-o'><span></span></a>", 0);
...
public function handler_format_format($sender)
{
	...
	// Punaner: [r]punane[/r]
	$sender->content = preg_replace("|\[r\](.*?)\[/r\]|si", "<r>$1</r>", $sender->content);
