...
public function setMuted(&$conversation, $memberId, $muted)
{
	...
	public function setiprobleem(&$conversation, $memberId, $pooleli)
	{
		$pooleli = (bool)$pooleli;
		$this->setStatus($conversation["conversationId"], $memberId, array("probleem" => $pooleli));
		$this->addOrRemoveLabel($conversation, "probleem", $pooleli);
		$conversation["probleem"] = $pooleli;
	}
